...
const ProjectGridItem = ({ project }: Props) => {
   return (
      ...
      >
         ...
         <div className="absolute inset-0 grid place-items-center opacity-0 backdrop-blur-xl transition-all duration-300 ease-in-out group-hover/project-grid:opacity-100">
